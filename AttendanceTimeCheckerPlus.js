(function() {
    ...
    let userPreferences = {
        ...
        // Mark destinations an opponent could reach next turn. The 'hard' CPU
        // already computes this and refuses such squares — measured, it lands
        // in danger 6.8% of the time against a player's 17%. Showing it closes
        // an information gap; it does not change a single rule.
        ludoWarnCapture: true,
        ...
        modal.innerHTML = `
            ...
            <div class="settings-option" style="align-items: flex-start; flex-direction: column; gap: 10px;">
                ...
                <div class="ludo-rule-toggles">
                    ...
                    <div class="ludo-rule-row">
                        <span>Warn if a move can be captured <small style="opacity:0.6;">(the hard CPU already knows)</small></span>
                        <div class="toggle-switch ${userPreferences.ludoWarnCapture !== false ? 'active' : ''}" data-pref="ludoWarnCapture"></div>
                    </div>
                </div>
            </div>
